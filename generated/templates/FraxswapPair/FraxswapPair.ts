...
export class FraxswapPair__TWAPObservationHistoryResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class FraxswapPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class FraxswapPair__getDetailedOrdersForUserResultDetailed_ordersStruct extends ethereum.Tuple {
  get id(): BigInt {
...
export class FraxswapPair__getReserveAfterTwammResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FraxswapPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class FraxswapPair__getTwammOrderResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: Address;
...
export class FraxswapPair__getTwammOrderProceedsResult {
  value0: boolean;
  value1: BigInt;
...
export class FraxswapPair__getTwammOrderProceedsViewResult {
  value0: boolean;
  value1: BigInt;
...
export class FraxswapPair__getTwammReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FraxswapPair__getTwammRewardFactorResult {
  value0: BigInt;
  value1: BigInt;
...
export class FraxswapPair__getTwammSalesRateEndingResult {
  value0: BigInt;
  value1: BigInt;
...
export class FraxswapPair__getTwammStateResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class FraxswapPair__withdrawProceedsFromLongTermSwapResult {
  value0: boolean;
  value1: Address;
  value2: BigInt;
...
export class FraxswapPair extends ethereum.SmartContract {
  static bind(address: Address): FraxswapPair {
    return new FraxswapPair("FraxswapPair", address);
  }
  ...
  TWAPObservationHistory(
    param0: BigInt
  ): FraxswapPair__TWAPObservationHistoryResult {
    let result = super.call(
      "TWAPObservationHistory",
    ...
    return new FraxswapPair__TWAPObservationHistoryResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_TWAPObservationHistory(
    param0: BigInt
  ): ethereum.CallResult<FraxswapPair__TWAPObservationHistoryResult> {
    let result = super.tryCall(
      "TWAPObservationHistory",
      "TWAPObservationHistory(uint256):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new FraxswapPair__TWAPObservationHistoryResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  burn(to: Address): FraxswapPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new FraxswapPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<FraxswapPair__burnResult> {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getDetailedOrdersForUser(
    ...
    offset: BigInt,
    limit: BigInt
  ): Array<FraxswapPair__getDetailedOrdersForUserResultDetailed_ordersStruct> {
    let result = super.call(
      "getDetailedOrdersForUser",
    ...
    return result[0].toTupleArray<
      FraxswapPair__getDetailedOrdersForUserResultDetailed_ordersStruct
    >();
  }
  ...
  getNextOrderID(): BigInt {
    let result = super.call("getNextOrderID", "getNextOrderID():(uint256)", []);
  ...
  getReserveAfterTwamm(
  ...
  ): FraxswapPair__getReserveAfterTwammResult {
    let result = super.call(
      "getReserveAfterTwamm",
    ...
    return new FraxswapPair__getReserveAfterTwammResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getReserveAfterTwamm(
    blockTimestamp: BigInt
  ): ethereum.CallResult<FraxswapPair__getReserveAfterTwammResult> {
    let result = super.tryCall(
      "getReserveAfterTwamm",
      "getReserveAfterTwamm(uint256):(uint112,uint112,uint256,uint112,uint112)",
      [ethereum.Value.fromUnsignedBigInt(blockTimestamp)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__getReserveAfterTwammResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getReserves(): FraxswapPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new FraxswapPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<FraxswapPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getTwammOrder(orderId: BigInt): FraxswapPair__getTwammOrderResult {
    let result = super.call(
      "getTwammOrder",
    ...
    return new FraxswapPair__getTwammOrderResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toAddress(),
  ...
  try_getTwammOrder(
    orderId: BigInt
  ): ethereum.CallResult<FraxswapPair__getTwammOrderResult> {
    let result = super.tryCall(
      "getTwammOrder",
      "getTwammOrder(uint256):(uint256,uint256,uint256,address,address,address)",
      [ethereum.Value.fromUnsignedBigInt(orderId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__getTwammOrderResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toAddress(),
  ...
  getTwammOrderProceeds(
    orderId: BigInt
  ): FraxswapPair__getTwammOrderProceedsResult {
    let result = super.call(
      "getTwammOrderProceeds",
    ...
    return new FraxswapPair__getTwammOrderProceedsResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try_getTwammOrderProceeds(
    orderId: BigInt
  ): ethereum.CallResult<FraxswapPair__getTwammOrderProceedsResult> {
    let result = super.tryCall(
      "getTwammOrderProceeds",
      "getTwammOrderProceeds(uint256):(bool,uint256)",
      [ethereum.Value.fromUnsignedBigInt(orderId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__getTwammOrderProceedsResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
  ...
  getTwammOrderProceedsView(
    orderId: BigInt,
    blockTimestamp: BigInt
  ): FraxswapPair__getTwammOrderProceedsViewResult {
    let result = super.call(
      "getTwammOrderProceedsView",
    ...
    return new FraxswapPair__getTwammOrderProceedsViewResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }
  ...
  try_getTwammOrderProceedsView(
    orderId: BigInt,
    blockTimestamp: BigInt
  ): ethereum.CallResult<FraxswapPair__getTwammOrderProceedsViewResult> {
    let result = super.tryCall(
      "getTwammOrderProceedsView",
      "getTwammOrderProceedsView(uint256,uint256):(bool,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__getTwammOrderProceedsViewResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
  ...
  getTwammReserves(): FraxswapPair__getTwammReservesResult {
    let result = super.call(
      "getTwammReserves",
    ...
    return new FraxswapPair__getTwammReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getTwammReserves(): ethereum.CallResult<
    FraxswapPair__getTwammReservesResult
  > {
    let result = super.tryCall(
      "getTwammReserves",
      "getTwammReserves():(uint112,uint112,uint32,uint112,uint112)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__getTwammReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getTwammRewardFactor(
  ...
  ): FraxswapPair__getTwammRewardFactorResult {
    let result = super.call(
      "getTwammRewardFactor",
    ...
    return new FraxswapPair__getTwammRewardFactorResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getTwammRewardFactor(
    _blockTimestamp: BigInt
  ): ethereum.CallResult<FraxswapPair__getTwammRewardFactorResult> {
    let result = super.tryCall(
      "getTwammRewardFactor",
      "getTwammRewardFactor(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(_blockTimestamp)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__getTwammRewardFactorResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getTwammSalesRateEnding(
    _blockTimestamp: BigInt
  ): FraxswapPair__getTwammSalesRateEndingResult {
    let result = super.call(
      "getTwammSalesRateEnding",
    ...
    return new FraxswapPair__getTwammSalesRateEndingResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getTwammSalesRateEnding(
    _blockTimestamp: BigInt
  ): ethereum.CallResult<FraxswapPair__getTwammSalesRateEndingResult> {
    let result = super.tryCall(
      "getTwammSalesRateEnding",
      "getTwammSalesRateEnding(uint256):(uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(_blockTimestamp)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__getTwammSalesRateEndingResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  getTwammState(): FraxswapPair__getTwammStateResult {
    let result = super.call(
      "getTwammState",
    ...
    return new FraxswapPair__getTwammStateResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_getTwammState(): ethereum.CallResult<FraxswapPair__getTwammStateResult> {
    let result = super.tryCall(
      "getTwammState",
      "getTwammState():(uint256,uint256,uint256,uint256,uint256,uint256)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__getTwammStateResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  newSwapsPaused(): boolean {
    let result = super.call("newSwapsPaused", "newSwapsPaused():(bool)", []);

    return result[0].toBoolean();
  }

  try_newSwapsPaused(): ethereum.CallResult<boolean> {
    let result = super.tryCall("newSwapsPaused", "newSwapsPaused():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  twammReserve0(): BigInt {
    let result = super.call("twammReserve0", "twammReserve0():(uint112)", []);
  ...
  twammReserve1(): BigInt {
    let result = super.call("twammReserve1", "twammReserve1():(uint112)", []);
  ...
  twammUpToDate(): boolean {
    let result = super.call("twammUpToDate", "twammUpToDate():(bool)", []);

    return result[0].toBoolean();
  }

  try_twammUpToDate(): ethereum.CallResult<boolean> {
    let result = super.tryCall("twammUpToDate", "twammUpToDate():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  withdrawProceedsFromLongTermSwap(
    orderId: BigInt
  ): FraxswapPair__withdrawProceedsFromLongTermSwapResult {
    let result = super.call(
      "withdrawProceedsFromLongTermSwap",
    ...
    return new FraxswapPair__withdrawProceedsFromLongTermSwapResult(
      result[0].toBoolean(),
      result[1].toAddress(),
      result[2].toBigInt()
    );
  ...
  try_withdrawProceedsFromLongTermSwap(
    orderId: BigInt
  ): ethereum.CallResult<FraxswapPair__withdrawProceedsFromLongTermSwapResult> {
    let result = super.tryCall(
      "withdrawProceedsFromLongTermSwap",
      "withdrawProceedsFromLongTermSwap(uint256):(bool,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(orderId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new FraxswapPair__withdrawProceedsFromLongTermSwapResult(
        value[0].toBoolean(),
        value[1].toAddress(),
        value[2].toBigInt()
      )
