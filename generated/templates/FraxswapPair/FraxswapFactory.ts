...
export class FraxswapFactory extends ethereum.SmartContract {
  static bind(address: Address): FraxswapFactory {
    return new FraxswapFactory("FraxswapFactory", address);
  }
